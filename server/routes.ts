    ...
    async (req: AuthRequest, res) => {
      try {
        ...
        const settingsData = {
          ...
          printerWebhookUrl: req.body.printerWebhookUrl || "",
          printerWebhookSecret: req.body.printerWebhookSecret || "",
          printerWebhookEnabled: req.body.printerWebhookEnabled ?? false,
